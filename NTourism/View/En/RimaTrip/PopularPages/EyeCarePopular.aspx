<%@ Page Title="EyeCare" Language="C#" MasterPageFile="~/View/En/RimaTrip/Master/Index.master" AutoEventWireup="true" CodeBehind="EyeCarePopular.aspx.cs" Inherits="RimaTrip.View.PopularPages.EyeCarePopular" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">

    <link href="../CssLibirary/EyeCarePopular.css" rel="stylesheet" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="PanelEyeCare" class=" PanelEyeCareStyle">
        ...
        <div class="container-fluid hidden-sm hidden-xs">
            ...
            <div class="row">
                ...
                <img src="/Resources/En/RimaTrip/PagePopularTreatments/EyeCarePopular/HeaderImgEyeCare1.png" alt="EyeCare" class="ImgHeaderEyeCareStyle" />
            </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="row DivBtnEyeCareSingInStyle">
                    <a href="/View/En/RimaTrip/Singup/Singup.aspx" title="SingIn" class="TextBtnEyeCareStyle btn">&nbsp;&nbsp;Register&nbsp;&nbsp; </a>
                </div>
            </div>
            ...
            <%--<div class="row text-center DivVideoAndTextEyeCareStyle">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                        <img src="/Resources/En/RimaTrip/PagePopularTreatments/EyeCarePopular/VideoEyeCare.png" alt="VideoEyeCare" class="VideoEyeCareStyle" />
                    </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 DescaptirionRowOneEyeCareStyle">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 text-center">
                            <img src="/Resources/En/RimaTrip/PagePopularTreatments/EyeCarePopular/Pic3EyeCare.png" class="Pic3EyeCareRowOneStyle" alt="Pic3EyeCare" />
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 DescaptirionRowTwoEyeCareStyle">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 text-center">
                            <img src="/Resources/En/RimaTrip/PagePopularTreatments/ImgMapIran.png" class="Pic1EyeCareRowTwoStyle" alt="Pic1EyeCare" />
                        </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 DescaptirionRowThreeEyeCareStyle">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 ">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 DivZirTitrTextRoThreeEyeCareStyle">
                                ...
                                If you have your eye care trip to Iran organized by RimaTrip, you will save yourself the hassle of booking accommodations, arranging hospital and doctor’s appointment, city transfer, and a lot more                          
                                </p>

                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 text-center ">
                            <img src="/Resources/En/RimaTrip/PagePopularTreatments/ImgSibSalamat.png" class="Pic2EyeCareRowThreeStyle" alt="Pic1EyeCare" />
                        </div>
                    </div>
        ...
        <div class="container-fluid hidden-lg hidden-md hidden-xs">
            ...
            <div class="row">
                <img src="/Resources/En/RimaTrip/PagePopularTreatments/EyeCarePopular/HeaderImgEyeCare1.png" alt="EyeCare" class="ImgHeaderEyeCareSmStyle" />
            </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="row DivBtnEyeCareSingInSmStyle">
                    <a href="/View/En/RimaTrip/Singup/Singup.aspx" title="SingIn" class="TextBtnEyeCareSmStyle btn">&nbsp;&nbsp;Register&nbsp;&nbsp; </a>
                </div>
            </div>
            ...
            <div class="row text-center DivVideoAndTextEyeCareSmStyle">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <img src="/Resources/En/RimaTrip/PagePopularTreatments/EyeCarePopular/VideoEyeCare.png" alt="VideoEyeCare" class="VideoEyeCareSmStyle" />
                    </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 DescaptirionRowOneEyeCareSmStyle">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                            <img src="/Resources/En/RimaTrip/PagePopularTreatments/EyeCarePopular/Pic3EyeCare.png" class="Pic3EyeCareRowOneTransplantSmStyle" alt="Pic3EyeCare" />
                        </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 DescaptirionRowTwoEyeCareSmStyle">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                            <img src="/Resources/En/RimaTrip/PagePopularTreatments/ImgMapIran.png" class="Pic1EyeCareRowTwoTransplantSmStyle" alt="Pic1EyeCare" />
                        </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 DescaptirionRowThreeEyeCareSmStyle">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center ">
                            <img src="/Resources/En/RimaTrip/PagePopularTreatments/ImgSibSalamat.png" class="Pic2EyeCareRowThreeTransplantSmStyle" alt="Pic1EyeCare" />
                        </div>
        ...
        <div class="container-fluid hidden-lg hidden-md hidden-sm">
            ...
            <div class="row">
                <img src="/Resources/En/RimaTrip/PagePopularTreatments/EyeCarePopular/HeaderImgEyeCare1.png" alt="EyeCare" class="ImgHeaderEyeCareXsStyle" />
            </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="row DivBtnEyeCareSingInXsStyle">
                    <a href="/View/En/RimaTrip/Singup/Singup.aspx" title="SingIn" class="TextBtnEyeCareXsStyle btn">&nbsp;&nbsp;Register&nbsp;&nbsp; </a>
                </div>
            </div>
            ...
            <div class="row text-center DivVideoAndTextEyeCareXsStyle">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <img src="/Resources/En/RimaTrip/PagePopularTreatments/EyeCarePopular/VideoEyeCare.png" alt="VideoEyeCare" class="VideoEyeCareXsStyle" />
                    </div>
            ...
            <div class="row DescaptirionOrginalEyeCareXsStyle">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 DescaptirionRowOneEyeCareXsStyle">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                            <img src="/Resources/En/RimaTrip/PagePopularTreatments/EyeCarePopular/Pic3EyeCare.png" class="Pic3EyeCareTransplantRowOneTransplantXsStyle" alt="Pic3EyeCare" />
                        </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 DescaptirionRowTwoEyeCareXsStyle">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                            <img src="/Resources/En/RimaTrip/PagePopularTreatments/ImgMapIran.png" class="Pic1EyeCareRowTwoTransplantXsStyle" alt="Pic1EyeCare" />
                        </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 DescaptirionRowThreeEyeCareXsStyle">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center ">
                            <img src="/Resources/En/RimaTrip/PagePopularTreatments/ImgSibSalamat.png" class="Pic2EyeCareRowThreeTransplantXsStyle" alt="Pic1EyeCare" />
                        </div>
