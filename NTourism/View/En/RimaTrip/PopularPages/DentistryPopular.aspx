<%@ Page Title="Dentistry" Language="C#" MasterPageFile="~/View/En/RimaTrip/Master/Index.master" AutoEventWireup="true" CodeBehind="DentistryPopular.aspx.cs" Inherits="RimaTrip.View.PopularPages.DentistryPopular" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="../CssLibirary/DentistryPopular.css" rel="stylesheet" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <div id="PanelDentistry" class="PanelDentistryStyle">
        ...
        <div class="container-fluid  hidden-sm hidden-xs">
            ...
            <div class="row">
                <img src="/Resources/En/RimaTrip/PagePopularTreatments/DentistryPopular/HeaderImgDentistry1.png" alt="Dentistry" class="ImgHeaderDentistryStyle " />
            </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="row DivBtnDentistrySingInStyle">
                    <a href="/View/En/RimaTrip/Singup/Singup.aspx" title="SingIn" class="TextBtnDentistryStyle btn">&nbsp;&nbsp;Register&nbsp;&nbsp; </a>
                </div>
            </div>
            ...
            <%-- <div class="row text-center DivVideoAndTextDentistryStyle">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                        <img src="/Resources/En/RimaTrip/PagePopularTreatments/DentistryPopular/VideoDentistry.png" alt="VideoDentistry" class="VideoDentistryStyle" />
                    </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 DescaptirionRowOneDentistryStyle">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 text-center">
                            <img src="/Resources/En/RimaTrip/PagePopularTreatments/DentistryPopular/Pic3Dentistry.png" class="Pic3DentistryRowOneStyle" alt="Pic3Dentistry" />
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 DescaptirionRowTwoDentistryStyle">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 text-center">
                            <img src="/Resources/En/RimaTrip/PagePopularTreatments/ImgMapIran.png" class="Pic1DentistryRowTwoStyle" alt="Pic1Dentistry" />
                        </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 DescaptirionRowThreeDentistryStyle">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 text-center ">
                            <img src="/Resources/En/RimaTrip/PagePopularTreatments/ImgSibSalamat.png" class="Pic2DentistryRowThreeStyle" alt="Pic1Dentistry" />
                        </div>
                    </div>
        ...
        <div class="container-fluid hidden-lg hidden-md hidden-xs">
            ...
            <div class="row">
                <img src="/Resources/En/RimaTrip/PagePopularTreatments/DentistryPopular/HeaderImgDentistry1.png" alt="Dentistry" class="ImgHeaderDentistrySmStyle" />
            </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="row DivBtnDentistrySingInSmStyle">
                    <a href="/View/En/RimaTrip/Singup/Singup.aspx" title="SingIn" class="TextBtnDentistrySmStyle btn">&nbsp;&nbsp;Register&nbsp;&nbsp; </a>
                </div>
            </div>
            ...
            <%--            <div class="row text-center DivVideoAndTextDentistrySmStyle">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <img src="/Resources/En/RimaTrip/PagePopularTreatments/DentistryPopular/VideoDentistry.png" alt="VideoDentistry" class="VideoDentistrySmStyle" />
                    </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 DescaptirionRowOneDentistrySmStyle">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                            <img src="/Resources/En/RimaTrip/PagePopularTreatments/DentistryPopular/Pic3Dentistry.png" class="Pic3DentistryRowOneTransplantSmStyle" alt="Pic3Dentistry" />
                        </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 DescaptirionRowTwoDentistrySmStyle">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                            <img src="/Resources/En/RimaTrip/PagePopularTreatments/ImgMapIran.png" class="Pic1DentistryRowTwoTransplantSmStyle" alt="Pic1Dentistry" />
                        </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 DescaptirionRowThreeDentistrySmStyle">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center ">
                            <img src="/Resources/En/RimaTrip/PagePopularTreatments/ImgSibSalamat.png" class="Pic2DentistryRowThreeTransplantSmStyle" alt="Pic1Dentistry" />
                        </div>
        ...
        <div class="container-fluid hidden-lg hidden-md hidden-sm">
            ...
            <div class="row">
                <img src="/Resources/En/RimaTrip/PagePopularTreatments/DentistryPopular/HeaderImgDentistry1.png" alt="Dentistry" class="ImgHeaderDentistryXsStyle" />
            </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="row DivBtnDentistrySingInXsStyle">
                    <a href="/View/En/RimaTrip/Singup/Singup.aspx" title="SingIn" class="TextBtnDentistryXsStyle btn">&nbsp;&nbsp;Register&nbsp;&nbsp; </a>
                </div>
            </div>
            ...
            <%--<div class="row text-center DivVideoAndTextDentistryXsStyle">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <img src="/Resources/En/RimaTrip/PagePopularTreatments/DentistryPopular/VideoDentistry.png" alt="VideoDentistry" class="VideoDentistryXsStyle" />
                    </div>
            ...
            <div class="row DescaptirionOrginalDentistryXsStyle">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 DescaptirionRowOneDentistryXsStyle">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                            <img src="/Resources/En/RimaTrip/PagePopularTreatments/DentistryPopular/Pic3Dentistry.png" class="Pic3DentistryTransplantRowOneTransplantXsStyle" alt="Pic3Dentistry" />
                        </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 DescaptirionRowTwoDentistryXsStyle">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                            <img src="/Resources/En/RimaTrip/PagePopularTreatments/ImgMapIran.png" class="Pic1DentistryRowTwoTransplantXsStyle" alt="Pic1Dentistry" />
                        </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 DescaptirionRowThreeDentistryXsStyle">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center ">
                            <img src="/Resources/En/RimaTrip/PagePopularTreatments/ImgSibSalamat.png" class="Pic2DentistryRowThreeTransplantXsStyle" alt="Pic1Dentistry" />
                        </div>
