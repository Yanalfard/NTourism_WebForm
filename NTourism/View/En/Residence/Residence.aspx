<%@ Page Title="" Language="C#" MasterPageFile="~/View/En/Master/Index/NTourism.Master" AutoEventWireup="true" CodeBehind="Residence.aspx.cs" Inherits="NTourism.View.En.Residence.Residence" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
      <script src="/StyleScriptsNTourism/Script/Residence.js"></script>
    <link href="/StyleScriptsNTourism/Style/Residence.css" rel="stylesheet" />
</asp:Content>
        ...
        <div class="divRow1ContactUsPageStyle">
            ...
            <div class="divInRow1TheRow2ContactUsPageStyle">
                ...
                <div class="row" style="padding: 2em 5em;">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        دانلود فرم
                    <a class="btn btn-success" href="/Resources/Residence/Form/Residence.zip" download>
