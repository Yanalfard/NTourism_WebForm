...
{
    public class uploadPdfFCooperationController : ApiController
    {
        public Task<HttpResponseMessage> uploadfile()
        {
            ...
            string rootpath = HttpContext.Current.Server.MapPath("~/Resources/Collaborate");
                ...
                ContinueWith(t =>
                {
                    ...
                    foreach (MultipartFileData item in provider.FileData)
                    {
                        try
                        {
                            ...
                            string fileRelativePath = "~/Resources/Collaborate/" + newfilename;
